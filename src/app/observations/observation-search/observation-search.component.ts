...
import { Eyepiece, Filter, Lens, Scope } from '../../shared/models/equipment/equipment';
...
@Component({
  ...
  imports: [MatFormFieldModule, MatSelectModule, FormsModule, TargetSelectorComponent],
})
