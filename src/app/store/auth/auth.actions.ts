...
export const populateSuccess = createAction('[Auth] Populate Success', props<{ user: User }>());

export const populateFailure = createAction('[Auth] Populate Failure', props<{ error: Error }>());
